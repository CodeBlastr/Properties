...
$this->set('context_menu', array('menus' => array(
	array(
		...
		'items' => array(
			...
			$this->Html->link('Delete', array('action' => 'delete', $this->request->data['PropertyDeveloper']['id']), null, __('Are you sure you want to delete %s?', $this->request->data['PropertyDeveloper']['name']))
			)
		),
	)));